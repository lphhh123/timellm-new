...
class Dataset_IMU(Dataset):
    ...
    def __getitem__(self, index):
        ...
        seq_y_label = seq_y_label[-self.pred_len:]
...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        self.scaler = StandardScaler()
        # temp_path = r'E:\TS\Time-LLM\dataset\dataset\ETT-small\ETTh1.csv'
        ...
        if self.timeenc == 0:
            ...
            # 使用 drop 方法删除原始的 date 列，并将剩下的特征值转换为 NumPy 数组 data_stamp。
